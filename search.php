...
<body style="background-color: black;">
 ...
 <div class="container" >
    ...
    <form class="well form-horizontal" method="post" action="search.php"  id="contact_form" style="border-radius: 40px;margin-top: 140PX;">
<fieldset>
...
foreach ($xml->participant as $value) {
  ...
  if ($value->firstName==$id) {
    ...
    echo "<td> ".$value->lastName."</td>";
        echo "<td><a class='text-info' href='update.php?id=".$value->attributes()->{'id'}."'> update</a></td>";
        echo "<td><a class='text-info' href='delete.php?id=".$value->attributes()->{'id'}."'> delete</a></td>";
      ...
      <div class="row">
       ...
       All rights reserved
          <div class="credits">
            ...
            Designed by Taha_zeidane <a href="https://bootstrapmade.com/"></a>
          </div>
        </div>
        <div class="col-sm-5 footer-social">
          <div class="pull-right hidden-xs hidden-sm">
            <a href="#"><i class="fa fa-facebook"></i></a>
            <a href="#"><i &&&&&&&&addddddddddddddddddddddqqqqqqqqqqqqqqqqqqqqqqqqfffffffffffffffffffffcccccccc(ffffffffffffggtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttggggggggggggggtttttttttttttttttttttttttttttttty  ybybbn,"ewziiiiiiiiiiiiiii#€vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv,kkkkkkkk,oo"okçè_bclass="fa fa-dribbble"></i></a>
