...
\vspace{\baselineskip}
\begin{Center}
{\fontsize{24pt}{28.0pt}\selectfont \textbf{
Reçu de paiement pour Monsieur
...
\vspace{\baselineskip}
\begin{Center}
Montant payé:	<xsl:value-of select="payement/@montant"/>\hspace*{2mm}<xsl:value-of select="payement/@devise"/>
