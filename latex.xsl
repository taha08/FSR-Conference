...
\vspace{\baselineskip}
\begin{Center}
a participé à l’activité de formation continue intitulée : \\
Conference IAO
...
\vspace{\baselineskip}
\begin{Center}
{\fontsize{10pt}{12.0pt}\selectfont Cette activité fait partie du programme d’activités de formation continue en psychothérapie adopté par\\
 l’Ordre des psychologues du Québec.\par}
\end{Center}\par
